...
pixi run -e gpu python simulate.py kernel=cuda_v2 timing_mode=per_stage         # fully fused (10-15x at N>=200K)
pixi run -e gpu python simulate.py kernel=cuda_v1                               # naive atomicAdd (ties jax)
pixi run -e gpu python simulate.py kernel=cuda_v3                               # warp reduction (ties jax)
